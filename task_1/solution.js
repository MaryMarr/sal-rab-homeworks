function addInCartMessage(title, price) {
    ...
    let message = productName; // создайте переменную message // присвойте переменной message значение переменной productName
...
function addInCartCountChange(value) {
    ...
    let oldValue = value;
    let newValue = oldValue + 1; // создайте переменную newValue. присвойте ей значение oldValue. увеличьте значение newValue на 1
